      ...
      <section id="bio" class="container">
          <div class="row">
              <div class="col-12 col-sm-7">
                  ...
                  <p>Apasionado por la tecnología y gestión de proyectos. Soy ingeniero de sistemas progamador full stack y de Bases de datos.</p>
              ...
              <div class="col-10 col-sm-3 py-5 pe-5 d-none d-sm-block">
                  <img src="imagenes/foto.png" alt="foto-David" class="img-fluid">
              </div>
      ...
      <section id="stack">
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-6 col-sm-2">
                    <div class="tecnologia mb-4">
                        <h3 class="pt-5 pb-1">Slack</h3>
                        <i class="fa-brands fa-slack pb-5"></i>
                    </div>
                </div>
                <div class="col-6 col-sm-2">
                  <div class="tecnologia mb-4">
                      <h3 class="pt-5 pb-1">Node</h3>
                      <i class="fa-brands fa-node pb-5"></i>
                  </div>
              </div>
                  <div class="col-6 col-sm-2">
                    <div class="tecnologia mb-4">
                        <h3 class="pt-5 pb-1">Discord</h3>
                        <i class="fa-brands fa-discord pb-5"></i>
                    </div>
                </div>
              </div>
          </div>
            ...
            <div class="col-12 col-sm-6">
                <div class="row">
                    <div class="col-2 py-3 my-auto d-none d-sm-block">
                        <img src="imagenes/remington.png" class="img-fluid baw" title="David Liduena">
                    </div>
    ...
    <section id="formacion" class="container mb-5">
        ...
        <div class="row shadow bg-white rounded p-1">
            <div class="col-12 col-sm-6">
                <div class="row">
                    <div class="col-2 py-3 my-auto d-none d-sm-block">
                        <img src="imagenes/depc.png" class="img-fluid baw" title="David Liduena">
                    </div>
                    <div class="col-12- col-sm-10 p-3">
                        <h3>Programaciòn Full Stack</h3>
                        <h4>DePcsuite</h4>
                        <h5>Expedición: Oct 2022</h5>
                        <p></p>
                    </div>
                    <div class="col-2 py-3 my-auto d-none d-sm-block">
                      <img src="imagenes/acadelmo.png" class="img-fluid baw" title="David Liduena">
                  </div>
                  <div class="col-12- col-sm-10 p-3">
                      <h3>Programaciòn Full Stack</h3>
                      <h4>Acadelmo</h4>
                      <h5>Expedición: May 2024</h5>
                      <p></p>
                  </div>
                </div>
            </div>
